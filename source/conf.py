...
project = 'Cogitare Tutorials'
copyright = '2018, Aron Bordin'
author = 'Aron Bordin'
...
latex_documents = [
    (master_doc, 'Cogitare.tex', 'Cogitare Documentation',
     'Aron Bordin', 'manual'),
]
...
man_pages = [
    (master_doc, 'cogitare', 'Cogitare Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Cogitare', 'Cogitare Documentation',
     author, 'Cogitare', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'cogitare': ('http://docs.cogitare-ai.org/', None)
}
